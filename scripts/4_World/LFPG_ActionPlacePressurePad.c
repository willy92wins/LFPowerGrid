// =========================================================
// LF_PowerGrid - Custom placement action for PressurePad Kit (v1.8.0)
//
// Patron identico a LFPG_ActionPlaceMotionSensor / LFPG_ActionPlacePushButton.
//
// IMPORTANTE: Registrar en ActionConstructor.RegisterActions()
//   via actions.Insert(LFPG_ActionPlacePressurePad).
// =========================================================

class LFPG_ActionPlacePressurePad : ActionPlaceObject
{
    void LFPG_ActionPlacePressurePad()
    {
