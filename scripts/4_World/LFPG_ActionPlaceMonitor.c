// =========================================================
// LF_PowerGrid - Custom placement action for Monitor Kit (v0.9.0)
//
// Patron identico a LFPG_ActionPlaceCamera.
// IMPORTANTE: registrar en ActionConstructor.RegisterActions()
// via actions.Insert(LFPG_ActionPlaceMonitor).
// =========================================================

class LFPG_ActionPlaceMonitor : ActionPlaceObject
{
    void LFPG_ActionPlaceMonitor()
    {
