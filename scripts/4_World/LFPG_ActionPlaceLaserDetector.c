// =========================================================
// LF_PowerGrid - Custom placement action for LaserDetector Kit (v1.9.0)
//
// Patron identico a LFPG_ActionPlacePressurePad / LFPG_ActionPlaceMotionSensor.
//
// IMPORTANTE: Registrar en ActionConstructor.RegisterActions()
//   via actions.Insert(LFPG_ActionPlaceLaserDetector).
// =========================================================

class LFPG_ActionPlaceLaserDetector : ActionPlaceObject
{
    void LFPG_ActionPlaceLaserDetector()
    {
