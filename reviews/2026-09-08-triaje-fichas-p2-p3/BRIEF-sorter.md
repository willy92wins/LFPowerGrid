# BRIEF - Triaje de fichas P2/P3: Sorter (22 fichas)
...
## TU LOTE: las 22 fichas P2/P3 de Sorter
...
## AVISO CRITICO SOLO PARA ESTE LOTE
**Otra lane esta borrando la V3 del sorter ahora mismo** (`LFPG_SorterView.c`,
`LFPG_SorterController.c`, `LFPG_SorterTagView.c`, `LFPG_SorterPreviewRow.c`, `LFPG_Sorter.c`,
`LFPG_ActionOpenSorterPanel.c` y sus 3 layouts). La V4 (`scripts/4_World/test/`) se queda.

Por eso este lote necesita un veredicto extra, y es el mas valioso que puedes dar:
**`MUERE-CON-V3`** — la ficha solo existe en codigo de la V3 y desaparece con el borrado.

Y la pregunta que va con el: **¿el mismo defecto existe tambien en la V4?** Si una ficha vive en
las dos, NO muere con la V3: sobrevive, y hay que decirlo alto. Comprueba las dos versiones antes
de dar por muerta cualquier ficha del sorter.
